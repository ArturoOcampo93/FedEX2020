              ...
              <div class="row">
                <div class="col-12 maxwidth">
                  ...
                  <form class="" action="index.html" method="post">
                    <input type="text" name="" value="" placeholder="Numero de cajas">
                  </form>
                  ...
                  <p class="timer">Tiempo: <span>0:00:00</span></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="textcenter bigtext">Para más información y dudas acerca de la promoción comunícate al <a href="tel:018002283832">01 800 228 38 32</a> en un horario de lunes a viernes de 10:00 a 14:00 hrs.</p>
          </div>
